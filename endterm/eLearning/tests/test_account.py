...
from eLearning.account import UserRegisterAccount, CreateCourse, MaterialModule, TeacherFeedback
from eLearning.models import Profile, Course, Material, Feedback
...
class UserRegisterAccountTest(TestCase):
    ...
    def test_registration_form_valid(self):
        ...
        self.assertEqual(user.username, 'useradmin')
        self.assertEqual(user.email, 'useradmin@example.com')
