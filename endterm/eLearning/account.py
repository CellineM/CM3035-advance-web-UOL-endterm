...
class CreateCourse(forms.ModelForm): 
    class Meta:
        model = Course
        fields = ['course_name', 'course_description']  # Corrected field name for course_description

# Material creation form
class MaterialModule(forms.ModelForm):  # Corrected class name to use consistent casing
    class Meta:
        model = Material
