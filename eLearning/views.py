    ...
    if request.method == 'POST':
        ...
        if account_form.is_valid():
            ...
            if user.profile.type_of_user == 'teacher':
                return redirect('teacher_homepage') #go to teacher home page
            else:
                return redirect('student_homepage') #go to student home page
        else:
            # If form is not valid, re-render the form with errors
            return render(request, 'eLearning/register.html', {'form': account_form})
    else:
...
def user_login(request):
    ...
    return render(request, 'eLearning/login.html', {'form': account_form})
...
def home(request):
    if request.user.is_authenticated:
        ...
        if request.user.profile.type_of_user == 'teacher':
            ...
            return redirect('student_homepage')
    return render(request, 'eLearning/home.html')  # show this page if not logged in
...
def teacher_homepage(request):
    ...
    if request.user.profile.type_of_user == 'teacher':
        #get the courses if the user is teacher 
        ...
        return render(request, 'eLearning/teacher_homepage.html', {
...
def student_homepage(request):
    ...
    if request.user.profile.type_of_user == 'student':
        # retrieve all the courses that the student are currently enrolled in
        ...
        return render(request, 'eLearning/student_homepage.html', {
            'courses': courses,
...
def create_course(request):
    if request.user.profile.type_of_user == 'teacher':
        ...
        return render(request, 'eLearning/create_course.html', {'form': account_form})
    else:
        return redirect('home')
...
def add_material(request, course_id):
    ...
    return render(request, 'eLearning/add_material.html', {'form': account_form, 'course': course})
...
def course_information(request, course_id):
    ...
    return render(request, 'eLearning/course_information.html', {
        'course': course,
        'materials': materials,
        'a_teacher': a_teacher,
...
def full_people(request):
    ...
    if request.user.profile.type_of_user == 'teacher':
        ...
        return render(request, 'eLearning/full_people.html', {'students': students, 'teachers': teachers})
    else:
        return redirect('teacher_homepage')
...
def student_records(request):
    if request.user.profile.type_of_user == 'teacher':
        ...
        if request.headers.get('x-requested-with') == 'XMLHttpRequest':
            html = render_to_string('eLearning/partials/student_list.html', {'students': students})
            return JsonResponse({'html': html})

        return render(request, 'eLearning/student_records.html', {'students': students})
    else:
        return redirect('teacher_homepage')
...
def teacher_records(request):
    if request.user.profile.type_of_user == 'teacher':
        ...
        # Check if the request is an AJAX request
        if request.headers.get('x-requested-with') == 'XMLHttpRequest':
            html = render_to_string('eLearning/partials/teacher_list.html', {'teachers': teachers})
            return JsonResponse({'html': html})

        return render(request, 'eLearning/teacher_records.html', {'teachers': teachers})
    else:
        return redirect('teacher_homepage')
...
def student_information(request, student_id):
    ...
    return render(request, 'eLearning/student_information.html', {
        'student': student,
...
def send_feedback(request, course_id):
    ...
    return render(request, 'eLearning/send_feedback.html', {'form': form, 'course': course})
...
def view_feedback(request, feedback_id):
    ...
    return render(request, 'eLearning/view_feedback.html', {'feedback': feedback, 'course': course})
...
def current_status(request):
    ...
    return render(request, 'eLearning/current_status.html')
...
def student_teacher_list(request):
    ...
    return render(request, 'eLearning/student_teacher_list.html', {'teachers': teachers})
...
def teacher_contact_student(request):
    ...
    return render(request, 'eLearning/teacher_contact_student.html', {
        'students': students,
    })
...
def chat_messages(request, room_chat):
    ...
    return render(request, 'eLearning/chat_messages.html', {
        'room_chat': room_chat,
        'messages': messages,
    })
