...
urlpatterns = [
    ...
    path('people/all_students/', views.student_records, name='student_records'), # the records of all students enrolled
    path('people/all_teachers/', views.teacher_records, name='teacher_records'), #records of all teachers
    path('people/teachers/<int:teacher_id>/', views.teacher_records, name='teacher_records'), #view a specific teacher's records, identified by teacher_id
