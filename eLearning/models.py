...
class Profile(models.Model):
    #choices for type of user 
    USER_SELECTION = (
        ('student', 'Student'),
        ('teacher', 'Teacher'),
    )
    # choices for their availability
    STATUS_SELECTION = (
        ('available', 'Available'),
        ('busy', 'Busy'),
    ...
    # either teacher o student as the user
...
class Notification(models.Model):
    ...
    def __str__(self):
        return f"Notification for {self.user.username}: {self.messagenrollee}"
